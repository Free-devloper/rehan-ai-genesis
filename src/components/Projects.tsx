...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Built a production-oriented portfolio risk platform with LangGraph orchestration, deterministic Python risk engines, Qdrant-backed retrieval, and FastAPI APIs to monitor equity, credit, and liquidity exposure, run VaR/CVaR and stress simulations, and generate grounded, auditable risk workflows for multi-billion-dollar portfolios.',
    technologies: ['LangGraph', 'FastAPI', 'Python', 'Qdrant', 'PostgreSQL', 'Redis', 'Kafka', 'OpenRouter', 'AWS CloudWatch'],
